...
from uninmr_fnmr.utils import parse_select_atom, TargetScaler
...
class UniNMRTask(UnicoreTask):
    ...
    def add_args(parser):
        ...
        "--use-gat",
        action="store_true",
        help="use Graph Attention Network for node classification"  
        )
    ...
    def load_dataset(self, split, **kwargs):
        ...
        #############################################################################
        # === load adjacency ===
        adjacency_dataset = KeyDataset(dataset, "adjacency")
        adjacency_dataset = ToTorchDataset(adjacency_dataset, dtype='float32')
        adjacency_dataset = PrependAndAppend2DDataset(adjacency_dataset, 0.0)
        #############################################################################
